...
import RequestVisit from "@/components/ui/RequestVisit";
import RequestVisitBtn from "@/components/ui/RequestVisitBtn";
                                ...
                                <div className="md:col-span-7 lg:col-span-8 mb-14">
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <p className="text-sm font-IranYekan-Light text-[#73767C] mt-2">
                                            ...
                                            می‌ماند و پس از ارسال کالا و تایید
                                            کالا، مبلغ به حساب فروشنده واریز
                                            می‌شود.
                                        </p>
                                        {/* offer */}
